...
export default function LoginPage() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            navigate("/user/dashboard") //Redirige
    ...
    return (
        <div className="min-h-screen w-full flex justify-center items-center bg-gradient-to-r 
            ...
            <form onSubmit={handleLogin}
                ...
                <button type="submit" className="w-2/3 bg-rose-600 font-semibold text-white border border-gray-300 rounded-xl
