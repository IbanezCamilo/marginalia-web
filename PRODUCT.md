...
Marginalia is a literary blog platform for Spanish-language writing culture. It gives writers a home for long-form work and gives readers a space designed around careful reading, not consumption metrics.

Success looks like: a writer feeling proud to share their Marginalia URL; a reader bookmarking a post and coming back days later; neither group ever feeling like they landed on a generic blog template.
...
Voice is Spanish, conversational but precise. Sentences are earned. No filler. Reads like a well-edited essay.

## Anti-references

**Substack** — newsletter-first, email-CTA heavy, too SaaS product-adjacent. Marginalia is not a growth tool. It has no subscription popups, no engagement prompts, no "join 10,000 readers" banners. The platform disappears into the content.

Generic WordPress blog aesthetics — sidebar layouts, widget stacks, post-count badges that exist to look busy. Marginalia's information hierarchy is editorial, not SEO-optimized.
...
WCAG 2.1 AA compliance across both surfaces. Light and dark modes are both designed with full intention — contrast ratios must hold in each independently. Consider reduced-motion preferences for any animations.
